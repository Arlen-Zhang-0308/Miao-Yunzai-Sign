# 自用修改版，修正了Linux服务器端喵喵云崽插件无法签到的问题

此修改仅支持Linux系统下，使用TRSS机器人整合的Docker安装的Miao-Yunzai插件

## 使用方法

1. 在TRSS_AllBot的Docker里安装好Miao-Yunzai
2. 将此repo作为压缩文件下载，解压
3. 使用此repo里的plugins目录替换TRSS_AllBot/Miao-Yunzai/plugins目录（或使用plugins/geshin替换TRSS_AllBot/Miao-Yunzai/plugins/genshin目录）
4. 重启Miao-Yunzai

**注：** 每次更新或重装Miao-Yunzai后，都需要执行一次2、3、4步骤。

## Linux 下，TRSS_AllBot 的 Docker 安装方法

地址：https://trss.me/Install/Docker.html

---

原repo地址：https://gitee.com/yoimiya-kokomi/Miao-Yunzai
以下为原版Miao-Yunzai的README.md
